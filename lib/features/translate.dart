...
final CommandShortcutEvent translateCommand = CommandShortcutEvent(
  ...
  handler: _translateCommandHandler,
);

CommandShortcutEventHandler _translateCommandHandler = (editorState) {
  ...
  () async {
    ...
    final summary = await chatApi.assistantChat(
      chatInstruction: 'You will translate a given text to french.',
      userInput: text!,
      );
